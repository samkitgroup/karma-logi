...
> = {
  en: {
    ...
    steps: [
      ...
      "Use Hint to reveal a letter (−25% score), Clear to reset, or Skip.",
    ],
  ...
  hi: {
    ...
    steps: [
      ...
      "Hint से अक्षर खुलता है (−25% अंक), Clear से साफ़ करें, या Skip करें।",
    ],
  ...
  gu: {
    ...
    steps: [
      ...
      "Hint થી અક્ષર ખુલે છે (−25% સ્કોર), Clear થી સાફ કરો, અથવા Skip કરો.",
    ],
