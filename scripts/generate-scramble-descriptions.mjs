...
const PRAKRITI_EN = {
  mati_gyanavarniya:
    "Obscures ordinary, everyday understanding of things.",
  shruta_gyanavarniya:
    "Obscures knowledge gained from scriptures and teachings.",
  avadhi_gyanavarniya:
    "Obscures clairvoyant knowledge of distant objects and events.",
  manahparyaya_gyanavarniya:
    "Obscures knowledge of another being's thoughts.",
  kevala_gyanavarniya:
    "Obscures omniscient, complete knowledge of reality.",
  chakshu_darshnavarniya:
    "Obscures perception through the physical eyes.",
  achakshu_darshnavarniya:
    "Obscures perception without reliance on the eyes.",
  avadhi_darshnavarniya:
    "Obscures clairvoyant perception of distant things.",
  kevala_darshnavarniya:
    "Obscures perfect, unobstructed perception of truth.",
  ...
  mithyatva_mohaniya:
    "False belief that deludes the soul about reality.",
  samyaktva_mohaniya:
    "Right belief mixed with some remaining delusion.",
  mishra_mohaniya:
    "Mixed true and false belief that still deludes.",
  anantanubandhi_krodha:
    "Anger bound so tightly it lasts through the entire life.",
  anantanubandhi_mana:
    "Pride bound so tightly it lasts through the entire life.",
  anantanubandhi_maya:
    "Deceit bound so tightly it lasts through the entire life.",
  anantanubandhi_lobha:
    "Greed bound so tightly it lasts through the entire life.",
  ...
  vajra_rishabha_naracha:
    "Fixes the strongest bone-and-joint bodily structure.",
...
const KARMA_FALLBACK_EN = {
  gyanavarniya: "A subtype that obscures knowledge.",
  darshnavarniya: "A subtype that obscures perception.",
  mohaniya: "A subtype that deludes the soul.",
  antaraya: "A subtype that obstructs spiritual merit.",
  vedaniya: "A subtype that determines feeling.",
  ayushya: "A subtype that fixes lifespan.",
  nama: "A subtype that determines bodily characteristics.",
  gotra: "A subtype that fixes family status.",
};

function describePrakritiEn(id, karmaId) {
  if (PRAKRITI_EN[id]) {
    return PRAKRITI_EN[id];
  }

  return (
    KARMA_FALLBACK_EN[karmaId] ??
    "A specific subtype within this karma category."
  );
}
...
for (const karma of data) {
  for (const prakriti of karma.prakritis) {
    ...
    prakritiEntries[prakriti.id] = describePrakritiEn(prakriti.id, karma.id);
  }
}
